...
describe("EClassImpl", () => {
	...
	test("eGetFromID", () => {
		...
		expect(o.eGetFromID(EcoreConstants.ECLASS__EALL_STRUCTURAL_FEATURES,true)).toStrictEqual(o.eAllStructuralFeatures)
		expect(
			deepEqual(
		...
		expect(o.eGetFromID(EcoreConstants.ECLASS__ECROSS_REFERENCE_FEATURES,true)).toStrictEqual(o.eCrossReferenceFeatures)
		expect(
			deepEqual(
