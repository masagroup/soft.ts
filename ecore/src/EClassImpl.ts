...
export class EClassImpl extends EClassifierExt  implements EClass
{
    ...
    protected initEAllAttributes() : void {
        this._eAllAttributes = new BasicEObjectList<EAttribute>(this , EcoreConstants.ECLASS__EALL_ATTRIBUTES , -1 , false , false , false , true , false)
    }
    
    protected initEAllContainments() : void {
        this._eAllContainments = new BasicEObjectList<EReference>(this , EcoreConstants.ECLASS__EALL_CONTAINMENTS , -1 , false , false , false , true , false)
    }
    
    protected initEAllCrossReferences() : void {
        this._eAllCrossReferences = new BasicEObjectList<EReference>(this , EcoreConstants.ECLASS__EALL_CROSS_REFERENCES , -1 , false , false , false , true , false)
    }
    
    protected initEAllOperations() : void {
        this._eAllOperations = new BasicEObjectList<EOperation>(this , EcoreConstants.ECLASS__EALL_OPERATIONS , -1 , false , false , false , true , false)
    }
    
    protected initEAllReferences() : void {
        this._eAllReferences = new BasicEObjectList<EReference>(this , EcoreConstants.ECLASS__EALL_REFERENCES , -1 , false , false , false , true , false)
    }
    
    protected initEAllStructuralFeatures() : void {
        this._eAllStructuralFeatures = new BasicEObjectList<EStructuralFeature>(this , EcoreConstants.ECLASS__EALL_STRUCTURAL_FEATURES , -1 , false , false , false , true , false)
    }
    
    protected initEAllSuperTypes() : void {
        this._eAllSuperTypes = new BasicEObjectList<EClass>(this , EcoreConstants.ECLASS__EALL_SUPER_TYPES , -1 , false , false , false , true , false)
    }
    ...
    protected initEContainmentFeatures() : void {
        this._eContainmentFeatures = new BasicEObjectList<EStructuralFeature>(this , EcoreConstants.ECLASS__ECONTAINMENT_FEATURES , -1 , false , false , false , true , false)
    }
    
    protected initECrossReferenceFeatures() : void {
        this._eCrossReferenceFeatures = new BasicEObjectList<EStructuralFeature>(this , EcoreConstants.ECLASS__ECROSS_REFERENCE_FEATURES , -1 , false , false , false , true , false)
    }
    ...
    protected initEOperations() : EList<EOperation> {
        return new BasicEObjectList<EOperation>(this , EcoreConstants.ECLASS__EOPERATIONS ,EcoreConstants.EOPERATION__ECONTAINING_CLASS, true , true , true , false , false)
    }
    ...
    protected initEStructuralFeatures() : EList<EStructuralFeature> {
        return new BasicEObjectList<EStructuralFeature>(this , EcoreConstants.ECLASS__ESTRUCTURAL_FEATURES ,EcoreConstants.ESTRUCTURAL_FEATURE__ECONTAINING_CLASS, true , true , true , false , false)
    }
    ...
    eGetFromID(featureID : number , resolve : boolean ) : any {
        switch ( featureID ) {
            ...
            case EcoreConstants.ECLASS__EALL_CONTAINMENTS: {
                let list = this.eAllContainments
                if (!resolve) {
                    if (isEObjectList(list))
                        return list.getUnResolvedList()
                }
            ...
            case EcoreConstants.ECLASS__EALL_CROSS_REFERENCES: {
                let list = this.eAllCrossReferences
                if (!resolve) {
                    if (isEObjectList(list))
                        return list.getUnResolvedList()
                }
            ...
            case EcoreConstants.ECLASS__EALL_STRUCTURAL_FEATURES: {
                let list = this.eAllStructuralFeatures
                if (!resolve) {
                    if (isEObjectList(list))
                        return list.getUnResolvedList()
                }
            ...
            case EcoreConstants.ECLASS__ECONTAINMENT_FEATURES: {
                let list = this.eContainmentFeatures
                if (!resolve) {
                    if (isEObjectList(list))
                        return list.getUnResolvedList()
                }
            ...
            case EcoreConstants.ECLASS__ECROSS_REFERENCE_FEATURES: {
                let list = this.eCrossReferenceFeatures
                if (!resolve) {
                    if (isEObjectList(list))
                        return list.getUnResolvedList()
                }
