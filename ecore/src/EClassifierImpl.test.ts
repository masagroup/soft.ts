...
describe("EClassifierImpl", () => {
    ...
    test("getInstanceTypeName", () => {
        let o = new EClassifierImpl();
        // get default value
        expect(o.instanceTypeName).toBe("");
    });
    ...
    test("eGetFromID", () => {
        ...
        expect(o.eGetFromID(EcoreConstants.ECLASSIFIER__INSTANCE_TYPE_NAME, true)).toStrictEqual(
            o.instanceTypeName
        );
    });
    ...
    test("eSetFromID", () => {
        ...
        {
            let value = "Test String";
            o.eSetFromID(EcoreConstants.ECLASSIFIER__INSTANCE_TYPE_NAME, value);
            expect(o.eGetFromID(EcoreConstants.ECLASSIFIER__INSTANCE_TYPE_NAME, false)).toBe(value);
        }
    });
    ...
    test("eIsSetFromID", () => {
        ...
        expect(o.eIsSetFromID(EcoreConstants.ECLASSIFIER__INSTANCE_TYPE_NAME)).toBeFalsy();
    });
    ...
    test("eUnsetFromID", () => {
        ...
        {
            o.eUnsetFromID(EcoreConstants.ECLASSIFIER__INSTANCE_TYPE_NAME);
            let v = o.eGetFromID(EcoreConstants.ECLASSIFIER__INSTANCE_TYPE_NAME, false);
            expect(v).toBe("");
        }
    });
