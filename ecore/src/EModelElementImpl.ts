...
export class EModelElementImpl extends EObjectImpl implements EModelElement {
    ...
    protected initEAnnotations(): EList<EAnnotation> {
        return new BasicEObjectList<EAnnotation>(this, EcoreConstants.EMODEL_ELEMENT__EANNOTATIONS ,EcoreConstants.EANNOTATION__EMODEL_ELEMENT, true , true , true , false , false)
    }
