...
describe("EStructuralFeatureImpl", () => {
	...
	test("eGetFromID", () => {
		...
		expect(o.eGetFromID(EcoreConstants.ESTRUCTURAL_FEATURE__DEFAULT_VALUE_LITERAL,true)).toStrictEqual(o.defaultValueLiteral)
		expect(o.eGetFromID(EcoreConstants.ESTRUCTURAL_FEATURE__DERIVED,true)).toStrictEqual(o.isDerived)
		expect(o.eGetFromID(EcoreConstants.ESTRUCTURAL_FEATURE__ECONTAINING_CLASS,true)).toStrictEqual(o.eContainingClass)
