...
describe("CirculatingItemImpl", () => {
    ...
    test("eGetFromID", () => {
        ...
        expect(o.eGetFromID(LibraryConstants.CIRCULATING_ITEM__BORROWERS, true)).toStrictEqual(
            o.borrowers
        );
        expect(
            deepEqual(
        ...
        expect(o.eGetFromID(LibraryConstants.CIRCULATING_ITEM__COPIES, true)).toStrictEqual(
            o.copies
        );
    });
    ...
    test("eSetFromID", () => {
        ...
        expect(() => o.eSetFromID(-1, null)).toThrow(Error);
        {
            ...
            when(
                mockValue.eInverseAdd(o, LibraryConstants.BORROWER__BORROWED, anything())
            ).thenReturn(null);
