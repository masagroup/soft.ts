...
describe("LibraryImpl", () => {
    ...
    test("basicSetOwnerPdg", () => {
        ...
        o.basicSetOwnerPdg(value, notifications);
        ...
        expect(notification.featureID).toBe(LibraryConstants.LIBRARY__OWNER_PDG);
        expect(notification.oldValue).toBeNull();
        expect(notification.newValue).toBe(value);
        expect(notification.position).toBe(-1);
    });
    ...
    test("setParentBranch", () => {
        ...
        reset(mockValue);
        reset(mockResource);
        when(mockValue.eInverseRemove(o, LibraryConstants.LIBRARY__BRANCHES, null)).thenReturn(
            null
        );
        when(mockValue.eResource()).thenReturn(resource);
    ...
    test("eGetFromID", () => {
        ...
        expect(o.eGetFromID(LibraryConstants.LIBRARY__OWNER_PDG, true)).toStrictEqual(o.ownerPdg);
        expect(o.eGetFromID(LibraryConstants.LIBRARY__PARENT_BRANCH, true)).toStrictEqual(
            o.parentBranch
        );
    ...
    test("eSetFromID", () => {
        ...
        }
        {
            ...
            when(
                mockValue.eInverseAdd(
                    o,
                    ecore.EOPPOSITE_FEATURE_BASE - LibraryConstants.LIBRARY__BOOKS,
                    anything()
                )
            ).thenReturn(null);
...

        {
            ...
            when(
                mockValue.eInverseAdd(
                    o,
                    ecore.EOPPOSITE_FEATURE_BASE - LibraryConstants.LIBRARY__BORROWERS,
                    anything()
                )
            ).thenReturn(null);
...

        {
            ...
            when(
                mockValue.eInverseAdd(o, LibraryConstants.LIBRARY__PARENT_BRANCH, anything())
            ).thenReturn(null);
...

        {
            ...
            when(
                mockValue.eInverseAdd(
                    o,
                    ecore.EOPPOSITE_FEATURE_BASE - LibraryConstants.LIBRARY__EMPLOYEES,
                    anything()
                )
            ).thenReturn(null);
        ...
        }
        {
            ...
            when(
                mockValue.eInverseAdd(
                    o,
                    ecore.EOPPOSITE_FEATURE_BASE - LibraryConstants.LIBRARY__OWNER_PDG,
                    anything()
                )
            ).thenReturn(null);
            o.eSetFromID(LibraryConstants.LIBRARY__OWNER_PDG, value);
            expect(o.eGetFromID(LibraryConstants.LIBRARY__OWNER_PDG, false)).toBe(value);
            verify(
                mockValue.eInverseAdd(
                    o,
                    ecore.EOPPOSITE_FEATURE_BASE - LibraryConstants.LIBRARY__OWNER_PDG,
        ...
        }
        {
            ...
            when(mockValue.eResource()).thenReturn(null);
            when(mockValue.eInverseAdd(o, LibraryConstants.LIBRARY__BRANCHES, null)).thenReturn(
                null
            );
        ...
        }
        {
            ...
            when(
                mockValue.eInverseAdd(
                    o,
                    ecore.EOPPOSITE_FEATURE_BASE - LibraryConstants.LIBRARY__STOCK,
                    anything()
                )
            ).thenReturn(null);
...

        {
            ...
            when(
                mockValue.eInverseAdd(
                    o,
                    ecore.EOPPOSITE_FEATURE_BASE - LibraryConstants.LIBRARY__WRITERS,
                    anything()
                )
            ).thenReturn(null);
    ...
    test("eIsSetFromID", () => {
        ...
        expect(o.eIsSetFromID(LibraryConstants.LIBRARY__OWNER_PDG)).toBeFalsy();
    ...
    test("eUnsetFromID", () => {
        ...
        {
            o.eUnsetFromID(LibraryConstants.LIBRARY__OWNER_PDG);
            expect(o.eGetFromID(LibraryConstants.LIBRARY__OWNER_PDG, false)).toBeNull();
        }
        {
    ...
    test("eBasicInverseRemove", () => {
        ...
        }
        {
            let mockValue = mock<PersonInternal>();
            let value = instance(mockValue);
            o.eBasicInverseRemove(value, LibraryConstants.LIBRARY__OWNER_PDG, null);
        }
        {
            let mockValue = mock<LibraryInternal>();
            let value = instance(mockValue);
