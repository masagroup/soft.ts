...
export class LibraryPackageImpl extends ecore.EPackageExt implements LibraryPackage {
    ...
    private createPackageContents(): void {
        ...
        this._addressableClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.ADDRESSABLE
        );
        ...
        this._bookIndexClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.BOOK_INDEX
        );
        factory.createEAttributeFromContainerAndClassID(
            this._bookIndexClass,
            LibraryConstants.BOOK_INDEX__KEY
        );
        factory.createEAttributeFromContainerAndClassID(
            this._bookIndexClass,
            LibraryConstants.BOOK_INDEX__VALUE
        );

        this._bookOnTapeClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.BOOK_ON_TAPE
        );
        factory.createEReferenceFromContainerAndClassID(
        ...
        this._borrowerClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.BORROWER
        );
        factory.createEReferenceFromContainerAndClassID(
            this._borrowerClass,
        ...
        this._documentRootClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.DOCUMENT_ROOT
        );
        factory.createEReferenceFromContainerAndClassID(
        ...
        this._employeeClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.EMPLOYEE
        );
        factory.createEReferenceFromContainerAndClassID(
            this._employeeClass,
        ...
        this._lendableClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.LENDABLE
        );
        factory.createEAttributeFromContainerAndClassID(
            this._lendableClass,
            LibraryConstants.LENDABLE__COPIES
        );
        factory.createEReferenceFromContainerAndClassID(
            this._lendableClass,
        ...
        this._libraryClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.LIBRARY
        );
        factory.createEAttributeFromContainerAndClassID(
            this._libraryClass,
        ...
        factory.createEAttributeFromContainerAndClassID(
            this._libraryClass,
            LibraryConstants.LIBRARY__PEOPLE
        );
        factory.createEReferenceFromContainerAndClassID(
            this._libraryClass,
        ...
        this._periodicalClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.PERIODICAL
        );
        factory.createEAttributeFromContainerAndClassID(
        ...
        this._personClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.PERSON
        );
        factory.createEAttributeFromContainerAndClassID(
            this._personClass,
        ...
        this._videoCassetteClass = factory.createEClassFromContainerAndClassID(
            this,
        ...
        this._writerClass = factory.createEClassFromContainerAndClassID(
            this,
            LibraryConstants.WRITER
        );
        factory.createEAttributeFromContainerAndClassID(
            this._writerClass,
            LibraryConstants.WRITER__NAME
        );
        factory.createEReferenceFromContainerAndClassID(
            this._writerClass,
        ...
        this._bookCategoryType = factory.createEEnumFromContainerAndClassID(
            this,
            LibraryConstants.BOOK_CATEGORY
        );
    }
    ...
    private initializeExtendedMetaDataAnnotations(): void {
        ...
        {
            let eAnnotation = factory.createEAnnotationFromContainer(
                this.getLibrary_ParentBranch()
            );
            eAnnotation.source = source;
