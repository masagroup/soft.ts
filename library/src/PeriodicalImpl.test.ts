...
import { Item, LibraryConstants, PeriodicalImpl, getLibraryPackage } from "./internal";
...
describe("PeriodicalImpl", () => {
    ...
    test("eGetFromID", () => {
        ...
        expect(o.eGetFromID(LibraryConstants.PERIODICAL__ISSUES_PER_YEAR, true)).toStrictEqual(
            o.issuesPerYear
        );
